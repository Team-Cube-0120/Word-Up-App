        ...
        return (
            <ScrollView style={styles.container}>
                <Card>
                    ...
                    <View>
                        <Button title="Edit Start Date and Time" onPress={() => { this.startState(); this.showPicker(); }} />
                        <DateTimePickerModal
                    ...
                    <TextInput style={styles.textInput} value={this.state.rsvpCode}
                        onChangeText={(rsvpCode) => this.setState({ rsvpCode: rsvpCode })}></TextInput>
                    <Text style={styles.text}>Co-hosts</Text>
                    <TextInput style={styles.textInput} value={this.state.coHosts}
